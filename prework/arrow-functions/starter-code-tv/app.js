...
//      I don't even know what that is. "Window {window: Window, self: Window, document: document, name: "", location: Location, …}""
// 3. Explain why "this" is different when an arrow function is used.
    // 'this' retains the the value of the enlosing function scope.
//
